    ...
    <div className="flex-1 flex items-center justify-center p-4 bg-[#f6f8fa]">
      <div className="w-full max-w-md bg-white border border-[#d0d7de] rounded-lg p-6 shadow-sm space-y-5">
        <div className="flex flex-col items-center text-center space-y-1">
          ...
          <h1 className="text-lg font-bold text-[#1f2328]">Create Developer Account</h1>
          <p className="text-xs text-[#656d76]">
            Start designing with autosaved MongoDB persistence
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-xs font-semibold text-[#1f2328] flex items-center gap-1.5">
              <User className="w-3.5 h-3.5 text-[#656d76]" /> Full Name
            </label>
            <input
              type="text"
              required
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-[#1f2328] flex items-center gap-1.5">
              <Lock className="w-3.5 h-3.5 text-[#656d76]" /> Password (min. 6 chars)
            </label>
            <input
              type="password"
              required
        ...
        <div className="text-center pt-2 border-t border-[#d0d7de] text-xs text-[#656d76]">
          ...
          <Link href="/login" className="text-[#0969da] hover:underline font-semibold">
            Sign In
          </Link>
        </div>
      </div>
